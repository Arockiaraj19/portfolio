...
import user from "../../../assets/mukila_image.jpeg";

const AboutContainer=()=>{
    return (
    <div className="container flex h-96 relative px-9">
       <div className="h-full w-3/5 overflow-hidden box-border relative"> <Image src={user.src} className="overflow-hidden box-border"   alt="test"   layout='fill'
