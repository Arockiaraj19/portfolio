...
const AboutContainer=()=>{
    return (
    <div className="container flex h-96 sm:h-auto relative px-9 sm:flex-col sm:px-10 sm:gap-y-10">
       <div className="h-full w-1/3 sm:w-full overflow-hidden box-border relative"> <Image src={userImage.src} className="overflow-hidden box-border"   alt="test"   layout='responsive' width={300} height={300}
