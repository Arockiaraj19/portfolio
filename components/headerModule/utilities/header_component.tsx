...
const [nav,setNav]=useState(false);
  ...
  return (
    <div className={`w-full fixed z-[999] px-10 py-3 bg-primary flex justify-end sm:flex-col ${nav==false?"":'sm:h-full sm:justify-start'}`}>
     <div className={`${nav==true?"flex-1 h-full":"hidden"} transition-all flex-col justify-start`}>
 <div onClick={(e)=>setNav(false)} className='sm:flex sm:justify-end'>
   <FontAwesomeIcon icon={faMobile} className=' text-black h-10 w-10' />
   </div>
<ul className="flex-1 h-full bg-blue w-full  sm:flex-col sm:items-center sm:justify-around child:sm:w-fit child:sm:text-center child:sm:text-2xl child:p-3 child:ml-4 child:text-xs child:font-medium child:cursor-pointer child:overflow-hidden
...
child:after:absolute child:after:left-0 child:after:w-full child:after:h-[2px] child:after:bg-secondary child:after:content-'' child:after:opacity-0 child:after:transition-all child:after:bottom-0 child:after:translate-y-[-10px] hover:child:after:translate-y-0 hover:child:after:opacity-[1]">
    ...
    <li className="hover:font-semibold" ><a href="#project">Projects</a></li>
     <li className="hover:font-semibold"><a href="#skills">Skills</a></li> 
 ...
 <div onClick={(e)=>setNav(true)}  className='hidden sm:flex sm:justify-end'>
   <FontAwesomeIcon icon={faComputer} className=' text-black h-10 w-10' />
   </div>
